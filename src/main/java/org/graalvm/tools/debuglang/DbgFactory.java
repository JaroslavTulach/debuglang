...
public class DbgFactory {
    ...
    At is(@Name("at") KeywordAt at, String file, Colon c, Integer line, List<Watch> actions) {
    ...
    public static final class KeywordAt {
        KeywordAt(String k) {
        }
    }

    public static final class KeywordWatch {
